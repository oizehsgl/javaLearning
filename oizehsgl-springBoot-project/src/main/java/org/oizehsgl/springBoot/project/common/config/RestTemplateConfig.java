package org.oizehsgl.springBoot.project.common.config;
...
public class RestTemplateConfig {
  ...
  // RequestConfig.custom().setConnectTimeout(Timeout.ofSeconds(timeoutSecond)).setConnectionRequestTimeout(Timeout.ofSeconds(timeoutSecond)).build();
