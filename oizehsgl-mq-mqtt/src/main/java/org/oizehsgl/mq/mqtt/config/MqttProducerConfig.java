...
import org.oizehsgl.mq.mqtt.property.MqttProducerProperties;
...
public class MqttProducerConfig {
  @Autowired private MqttProducerProperties mqttProducerProperties;
  ...
  public MqttConnectOptions getMqttConnectOptions() {
    ...
    mqttConnectOptions.setWill(
        mqttProducerProperties.getWillTopic(),
        mqttProducerProperties.getWillContent().getBytes(),
        2,
        false);
  ...
  public MessageHandler mqttOutbound() {
    ...
    MqttPahoMessageHandler mqttPahoMessageHandler =
        new MqttPahoMessageHandler(
            mqttProducerProperties.getClientIdPrefix() + UUID.randomUUID(),
