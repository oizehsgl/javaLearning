...
import org.oizehsgl.javaLearning.library.mqtt.handler.MqttCustomerHandler;
import org.oizehsgl.javaLearning.library.mqtt.property.MqttConsumerProperties;
...
public class MqttConsumerConfig {
    ...
    @Resource
    private MqttCustomerHandler mqttCustomerHandler;
    ...
    public MqttConnectOptions getMqttConnectOptions() {
        ...
        mqttConnectOptions.setWill(mqttConsumerProperties.getWillTopic(), mqttConsumerProperties.getWillContent().getBytes(), 2, false);
    ...
    public MessageProducer inbound() {
        ...
        MqttPahoMessageDrivenChannelAdapter mqttPahoMessageDrivenChannelAdapter = new MqttPahoMessageDrivenChannelAdapter(
                ...
                defaultMqttPahoClientFactory, mqttConsumerProperties.getTopics());
        // 设置完成超时时间
