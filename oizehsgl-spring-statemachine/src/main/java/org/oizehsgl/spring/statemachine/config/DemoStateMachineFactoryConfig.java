...
import org.oizehsgl.spring.statemachine.hook.DemoStateMachineErrorAction;
...
public class DemoStateMachineFactoryConfig
    extends EnumStateMachineConfigurerAdapter<DemoState, DemoEvent> {
  public static final String LABEL = "demoStateMachineFactory";
  ...
  @Resource private DemoStateMachineErrorAction demoStateMachineErrorAction;
  @Resource private RedisDemoStateMachineRuntimePersister redisDemoStateMachineRuntimePersister;
   ...
   */
  @Override
  public void configure(StateMachineConfigurationConfigurer<DemoState, DemoEvent> config)
      throws Exception {
    config
        .withConfiguration()
        // 机器标识
   ...
   */
  @Override
  public void configure(StateMachineTransitionConfigurer<DemoState, DemoEvent> transitions)
      throws Exception {
    transitions
        // S1 E1 S2
        .withExternal()
        ...
        .first(
            DemoState.S6,
            demoStateMachineGuard,
            demoStateMachineAction,
