...
public class RedisStateMachineContextRepositoryAdapter<S, E>
   ...
   */
  public RedisStateMachineContextRepositoryAdapter(RedisConnectionFactory redisConnectionFactory,CustomStringRedisSerializer customStringRedisSerializer) {
  ...
  private static RedisTemplate<String,byte[]> createDefaultTemplate(RedisConnectionFactory connectionFactory, CustomStringRedisSerializer customStringRedisSerializer) {
