...
public final class GsonUtils {
  private static final Gson gson =
      new GsonBuilder()
          ...
          //// "user_name"->"User Name" FieldNamingPolicy.UPPER_CAMEL_CASE_WITH_SPACES
          // 将json中的字段名转换为首字母大写，单词之间以空格分割的格式
          //// "UserName"->"user_name" FieldNamingPolicy.LOWER_CASE_WITH_UNDERSCORES
          // 将json中的字段名转换为小写字母，单词之间以下划线分割的格式
          //// "UserName"->"user-name" FieldNamingPolicy.LOWER_CASE_WITH_DASHES
