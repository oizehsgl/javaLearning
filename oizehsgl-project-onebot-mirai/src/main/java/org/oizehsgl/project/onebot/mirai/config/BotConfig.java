package org.oizehsgl.project.onebot.mirai.config;
...
public class BotConfig {
  ...
  public Bot bot() {
    Bot bot =
        BotFactory.INSTANCE.newBot(projectProperties.getRobotId(), BotAuthorization.byQRCode());
    // Bot bot = BotFactory.INSTANCE.newBot(1874637099,
    // BotAuthorization.byPassword("O_2wmj7ddnxk"));
